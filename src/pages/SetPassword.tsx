    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="bg-card rounded-xl shadow-lg p-8 max-w-md w-full text-center space-y-4">
          ...
          <h1 className="text-xl font-bold text-foreground">Password Set Successfully!</h1>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="bg-card rounded-xl shadow-lg p-8 max-w-md w-full space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-2xl font-bold text-foreground">Welcome to HOMEJOY</h1>
          <p className="text-muted-foreground">Please set your password to get started</p>
        </div>
